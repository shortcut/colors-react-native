...
class colors extends Component {
  ...
  render() {
    return (
      <View style={styles.container}>
        ...
        <TouchableHighlight onPress={this.addColor} underlayColor={'rgba(170, 199, 224, 1.00)'} style={styles.button}>
          <Text >Add color</Text>
        </TouchableHighlight>
  ...
  addColor(){
    ...
    colors.push("rgb(" + this.state.red + "," + this.state.green + "," + this.state.blue +")");
    this.setState({
      colors: colors,
    });
  }
